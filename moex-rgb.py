...
def get_values(shared_data):
    while True:
        shared_data.stockValue = shared_data.driver.find_element_by_css_selector('.pid-13666-last').text
        try:
            red = shared_data.driver.find_element_by_css_selector('.bold.pid-13666-pc.redFont')
            shared_data.color = "red"
        except NoSuchElementException:
            pass
        try:
            green = shared_data.driver.find_element_by_css_selector('.bold.pid-13666-pc.greenFont')
