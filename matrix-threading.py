...
def get_values(shared_data):
    while True:
        shared_data.moexValue = driver.find_element_by_css_selector('.pid-13666-last').text
        try:
            red = driver.find_element_by_css_selector('.bold.redFont.pid-13666-pc')
            shared_data.color = "red"
        except NoSuchElementException:
            pass
        try:
            green = driver.find_element_by_css_selector('.bold.greenFont.pid-13666-pc')
