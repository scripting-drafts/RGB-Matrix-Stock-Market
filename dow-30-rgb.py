...
def get_values(shared_data):
    while True:
        shared_data.stockValue = shared_data.driver.find_element_by_css_selector('.pid-169-last').text
        try:
            red = shared_data.driver.find_element_by_css_selector('.bold.redFont.pid-169-pc')
            shared_data.color = "red"
        except NoSuchElementException:
            pass
        try:
            green = shared_data.driver.find_element_by_css_selector('.bold.greenFont.pid-169-pc')
